...
export default function TrafficAuthority() {
  ...
  if (!isAuthenticated || user?.role !== 'traffic_police') {
    ...
    <Layout showChatbot={false}>
      <div className="gov-container py-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 animate-fade-in">
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">Traffic Authority Dashboard</h1>
            <p className="text-muted-foreground">
              Monitor and respond to highway emergency alerts
            </p>
          </div>
